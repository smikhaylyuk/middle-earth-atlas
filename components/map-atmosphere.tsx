...
export function MapAtmosphere({chimneyPoints=chimneys,flockPaths=flocks}:{chimneyPoints?:readonly {x:number;y:number}[];flockPaths?:readonly {path:string;duration:number;delay:number}[]}={}) {
  return <>
