...
Mordor beyond the northern pass and the southern Anduin remain unfinished
beyond the present edge. No new major river or marsh current is invented.
...
The displayed asset is public/images/atlas-morannon.webp.

scripts/extend-morannon.mjs is the last stage of npm run build:atlas, after
