...
const field=buildRiverField([track(layout.anduin),track(layout.entwash),...gondor.anduin.map(track)],water);
const {data:paint,info:paintInfo}=await sharp('public/images/atlas-gondor.webp').ensureAlpha().raw().toBuffer({resolveWithObject:true});
